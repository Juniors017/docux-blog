      ...
      <header className={clsx("hero hero--primary", styles.thanksHero)}>
        <div className="container">
          ...
          <p className="hero__subtitle">
            A big thank you to everyone who contributed to the development of
            the components used on this site
          </p>
        </div>
      </header>
        ...
        <div className="row">
          <Column className="col--8 col--offset-2">
            <p className={styles.introText}>
              This site would not have been possible without the contribution of
              many talented developers. This page is dedicated to recognizing
          ...
          <Column className="col--8 col--offset-2">
            <Card className={styles.addYourself} shadow="lw">
              <CardBody>
                ...
                <p>
                  If you have developed a component used on this site and you
                  are not listed here, feel free to contact me so I can add your
                  name to this page.
                </p>
                <Link
