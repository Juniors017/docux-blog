...
blueSkyRecordKey: 3mr7pnrweak23
---
...
![The Front Matter form split into the Content, Classification and Social sections](/img/frontmattercms/post2/sections.png)
...
<Columns>
<Column>
![Front Matter's character counter on the title field](/img/frontmattercms/post2/seolimite.png)
</Column>
<Column>
![Front Matter's character counter flagging an over-limit description](/img/frontmattercms/post2/seolimitedescription.png)
</Column>
</Columns>
...
<Snippet
  filename=".frontmatter/config/frontmatter.json"
  source=".frontmatter/config/frontmatter.json"
/>

:::note Why that path?
This file started life as `frontmatter.json` at the project root, which is where Front Matter expects it. It has since moved into `.frontmatter/config/`, along with the content type, the snippets and the custom actions — a later article in this series covers that reorganisation.
:::
