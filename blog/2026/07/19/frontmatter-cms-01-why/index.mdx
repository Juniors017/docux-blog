...
image: "/img/frontmatter-cms.webp"
authors: ["docux"]
...
series: "CMS UI"
blueSkyRecordKey: 3mr4bnlu6ys2a
---
...
![Front Matter CMS paired with Docusaurus](/img/frontmatter-cms.webp)
...
On initialization, Front Matter generates a `frontmatter.json` file at the root of the project: this is the entry point of the configuration. It comes with a `.frontmatter/` folder where the extension keeps its own data — the tag vocabulary, the media database, your pinned items.
