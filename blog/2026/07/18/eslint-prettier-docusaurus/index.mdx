---
title: "ESLint and Prettier in a Docusaurus Blog"
slug: eslint-prettier-docusaurus-blog
description: "Adding ESLint and Prettier to a Docusaurus blog: flat config for JS and TypeScript, npm scripts, and the real bugs the linter caught."
...
series: Tools
blueSkyRecordKey: 3mqxb4ihuf22y
---
...
![Docux scrubbing a monitor full of syntax errors with a soapy sponge](/img/clean-code.webp)
