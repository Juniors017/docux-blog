...
description: "A floating 'back to top' button for Docusaurus: delayed appearance after 300px, click animation and smooth scroll behavior."
...
![Docux in a superhero cape flying back up above a city skyline](/img/scrolltotop.webp)
...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="components" expanded={true}>
      <Folder label="ScrollToTopButton" expanded={true}>
...
<Snippet
  filename="src/components/ScrollToTopButton/index.js"
  source="src/components/ScrollToTopButton/index.js"
/>

<Snippet
  filename="src/components/ScrollToTopButton/styles.module.css"
  source="src/components/ScrollToTopButton/styles.module.css"
/>
...
```jsx
<img src={buttontop} alt="Back to top" width="30" height="30" />
```
