...
![Docux in a top hat pulling a rabbit out of a hat on stage, applauded by a theatre full of meerkats](/img/remarkreplace.webp)
...
<Trees>
  <Folder label="plugins" expanded={true}>
    <Folder label="remark-replace-words" expanded={true}>
      <File label="index.js" icon="javascript" />
      <File label="replacements.json" icon="json" />
    </Folder>
  </Folder>
</Trees>
### Code
<Snippet
  filename="plugins/remark-replace-words/index.js"
  source="plugins/remark-replace-words/index.js"
/>
...
<Snippet
  filename="plugins/remark-replace-words/replacements.json"
  source="plugins/remark-replace-words/replacements.json"
/>
