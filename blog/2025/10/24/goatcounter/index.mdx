...
![Docux and a purple goat at a desk of monitors covered in analytics charts](/img/docuxgoatcounter.webp)
...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="utils" expanded={true}>
      <File label="goatcounter.js" icon="javascript" />
    </Folder>
  </Folder>
</Trees>
...
<center>![GoatCounter dashboard](/img/tdbgoatcounter.webp)</center>
