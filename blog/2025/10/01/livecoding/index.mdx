...
description: "Add interactive react-live code playgrounds to Docusaurus: theme installation, configuration, ReactLiveScope swizzle and example patterns."
...
<center>
  <div>![Docux streaming under a Live Coding sign](/img/livecoding.webp)</div>
</center>
...
<Snippet
  filename="src/theme/ReactLiveScope/index.js"
  source="src/theme/ReactLiveScope/index.js"
/>
...
<Tooltip model="teacher" text="Your turn!">
  You can now integrate maintainable, ergonomic interactive examples into your
  site.
</Tooltip>
