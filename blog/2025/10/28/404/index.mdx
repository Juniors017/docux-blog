...
![Docux shrugging in a blue server room under a neon 404 Page Not Found sign](/img/404bg.webp)
...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="theme" expanded={true}>
      <Folder label="NotFound" expanded={true}>
...
<Snippet
  filename="src/theme/NotFound/Content/index.js"
  source="src/theme/NotFound/Content/index.js"
/>
...
<Snippet
  filename="src/theme/NotFound/Content/styles.module.css"
  source="src/theme/NotFound/Content/styles.module.css"
/>

### Key points:

- Optimized WebP images: `static/img/404bg.webp` (desktop) and `static/img/404mobile.webp` (mobile) _to learn more about image optimization [See Cavo789's tutorial](https://www.avonture.be/blog/reduce-image-size)_
