---
title: "Component Skill Bars and Circles"
...
![Docux beside a blackboard where skills are drawn as coloured progress bars and pie charts](/img/skillbar.webp)
      ...
      <CardBody>
        <center>
          <Skill
            name={
              <>
                <LogoIcon name="docusaurus" size="64" />{" "}
              </>
            }
            value={85}
            type="circle"
    ...
    <Card>
      <CardBody>
        <Skill
          name={
            <>
              <LogoIcon name="javascript" size="24" />{" "}
            </>
          }
          value={95}
          type="bar"
...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="components" expanded={true}>
      <Folder label="Skill" expanded={true}>
...
### Code
<Snippet
  filename="src/components/Skill/index.js"
  source="src/components/Skill/index.js"
/>

<Snippet
  filename="src/components/Skill/styles.module.css"
  source="src/components/Skill/styles.module.css"
/>
...
<Skill
  ...
  value={95}
  type="bar"
  gradient={{ from: "#e3d626ff", to: "#1ad843ff" }}
/>
<Skill
  name="Sass"
  value={80}
  type="bar"
  gradient={{ from: "#CC6699", to: "#910b52ff" }}
/>
<Skill
  name="Tailwind"
  value={70}
  type="bar"
  gradient={{ from: "#065fd4ff", to: "#0891B2" }}
/>
...
>
  <Skill
    name={
      <>
        <LogoIcon name="html-5" size="24" /> HTML5
      </>
    }
    value={95}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="css-3" size="24" /> CSS3
      </>
    }
    value={90}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="javascript" size="24" /> JavaScript
      </>
    }
    value={85}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="typescript-icon-round" size="24" /> TypeScript
      </>
    }
    value={80}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="react" size="24" /> React
      </>
    }
    value={88}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="vue" size="24" /> Vue.js
      </>
    }
    value={75}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="nodejs" size="24" /> Node.js
      </>
    }
    value={82}
    type="bar"
  ...
  <Skill
    name={
      <>
        <LogoIcon name="python" size="24" /> Python
      </>
    }
    value={78}
    type="bar"
...
<Skill
  ...
  value={75}
  type="circle"
  gradient={{ from: "#0cb628ff", to: "#b7ed24ff" }}
  valuePosition="center"
/>
<Skill
  name="Kubernetes"
  value={65}
  type="circle"
  gradient={{ from: "#1c4cb4ff", to: "#1A73E8" }}
  valuePosition="center"
/>
<Skill
  name="AWS"
  value={70}
  type="circle"
  gradient={{ from: "#FF9900", to: "#f80929ff" }}
  valuePosition="center"
/>
...
>
  ...
  <Skill
    name={
      <>
        <LogoIcon name="typescript-icon-round" size="24" />{" "}
      </>
    }
    value={80}
    type="circle"
      ...
      <CardBody>
        <center>
          <Skill
            name={
              <>
                <LogoIcon name="javascript" size="64" />{" "}
              </>
            }
            value={85}
            type="circle"
