...
image: "/img/iconifycomponent.webp"
authors: ["docux"]
mainTag: Design
...
![Docux wheeling a trolley full of icons out of a shop signed Iconify Supermarket](/img/iconifycomponent.webp)

</div>
</center>

I created this component to easily display **[Iconify](https://icon-sets.iconify.design/) icons** in **MDX** pages of Docusaurus.  
...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="components" expanded={true}>
      <File label="LogoIcon.js" icon="javascript" />
    </Folder>
