...
description: "Create customizable card components in Docusaurus with Infima: React implementation, multiple card variants and responsive design."
...
![Docux holding a hand of playing cards across a table from a meerkat](/img/card-component-docusaurus-infima.webp)
