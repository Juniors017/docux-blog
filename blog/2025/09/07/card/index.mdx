...
<Trees>
  <Folder label="src" expanded={true}>
    <Folder label="components" expanded={true}>
      <Folder label="Card" expanded={true}>
        <File label="index.js" icon="javascript" />
        <File label="styles.module.css" icon="logos:css-3" />
        <Folder label="CardHeader" expanded={true}>
          <File label="index.js" icon="javascript" />
        </Folder>
        <Folder label="CardBody" expanded={true}>
          <File label="index.js" icon="javascript" />
        </Folder>
        <Folder label="CardFooter" expanded={true}>
          <File label="index.js" icon="javascript" />
        </Folder>
        <Folder label="CardImage" expanded={true}>
          <File label="index.js" icon="javascript" />
        </Folder>
      </Folder>
    </Folder>
...
<CardImage
  style={{ backgroundColor: "#87dfb8", color: "#2d2f4eff" }}
  cardImageUrl="/img/docux-and-christophe-learn-docusaurus.webp"
/>
...
<CardBody
  ...
  Transform="uppercase"
>
  <h3>DocuxLab</h3>A must-visit site for developers looking to expand their
...
<CardImage
  style={{ backgroundColor: "#7a9f3d", color: "#d7de3d" }}
  cardImageUrl="/img/docux-and-christophe-learn-docusaurus.webp"
/>

<CardBody
  style={{ backgroundColor: "#d7de3d", color: "#3d521cff" }}
  className="padding-vert--md"
  textAlign="justify"
  Transform="uppercase"
>
  <h3 className="text--center">DocuxLab</h3>A must-visit site for developers
...
<CardImage
  ...
  cardImageUrl="/img/card-component-docusaurus-infima.webp"
/>
...
<CardBody truncate>
  ...
  <p>
    {" "}
    {/* ← Will be truncated */}
    Very long text that will be automatically truncated after 3 lines with
    ellipsis at the end...
  </p>
</CardBody>
```
