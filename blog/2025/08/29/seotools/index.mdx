...
description: "Découvrez l'architecture SEO complète développée par Docux : composants SEO intelligents, SeoDebugPanel professionnel et support Schema.org étendu pour optimiser vos sites Docusaurus"
...
[![Documentation](https://img.shields.io/badge/Documentation-Complete-blue.svg)](/docs/seo)
</div>

![SEO Rex](./seorex.png)
</center>

> 📚 **Article complémentaire** : Pour la documentation technique détaillée, consultez le [Guide de Référence SEO](/src/components/Seo/README.md) qui accompagne cet article.
